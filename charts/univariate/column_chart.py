...
Only shown for Nominal / Ordinal / Location variables.
All bars share a single colour (one variable = one colour).
...
class ColumnChart(BaseChart):
    ...
    def render(self, df: pd.DataFrame, selection: VariableSelection, fig: Figure) -> None:
        ...
        # Guard: only meaningful for categorical / location variables
        ...
        # ── Draw bars — single colour for all bars ────────────────────────────
        x_pos = np.arange(n)
