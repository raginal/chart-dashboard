...
class ConsolidateDialog(QDialog):
    ...
    Values sharing the same group name are merged in charts.
    ...
    def __init__(
        ...
        self.setWindowTitle(f"Clean values — {column}")
        ...
        instr = QLabel(
            ...
            "Rows sharing the same group name will be combined in charts. "
